    ...
    return (
        <>
                ...
                </StyledSection>
            {
                !isLoading
                ?
                <div style={{backgroundColor: "#001B46", width: "100%", margin: "0px", padding: "0px"}}>
                    <div style={{backgroundColor: "white", width: "100%", margin: "0px", padding: "0px", borderTopLeftRadius: "30%"}}>
                        <Container style={{
